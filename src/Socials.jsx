...
import { redes } from "./siteContent";

const CHARS = redes.personajes;

const ROLES = redes.roles;

const ITEMS = redes.enlaces;
...
export default function Socials() {
  ...
  return (
    <div id="menu-screen">
      <video src={redes.videoFondo} autoPlay loop muted playsInline disablePictureInPicture />
      <style>{`
              ...
              <div className="sc-bar-content">
                ...
                <div className="sc-main">
                  <div className="sc-main-top">
                    <div className="sc-icon">{item.icono}</div>
                    <div className="sc-label">{item.etiqueta}</div>
                  </div>
                </div>
                <div className="sc-stats">
                  {item.stats.map(s => (
                    <div className="sc-stat" key={s.etiqueta}>
                      <div className="sc-stat-top">
                        <span className="sc-stat-tag" style={{ color: s.color, borderColor: s.color }}>{s.etiqueta}</span>
                        <span className="sc-stat-num">{s.valor}</span>
                      </div>
      ...
      <div className={`sc-footer${mounted ? " mounted" : ""}`}>
        <div className="sc-footer-row"><span className="sc-footer-key">↑↓</span><span>{redes.ayuda.seleccionar}</span></div>
        <div className="sc-footer-row"><span className="sc-footer-key">↵</span><span>{redes.ayuda.abrir}</span></div>
        <div className="sc-footer-row"><span className="sc-footer-key">ESC</span><span>{redes.ayuda.volver}</span></div>
      </div>

      <div className="sc-mobile-controls" aria-label={redes.ariaMovil}>
