...
import { sobreMi } from "./siteContent";

const CHARS = sobreMi.personajesBarra;
const MAIN_IMAGES = sobreMi.imagenesRetrato;
const REVEAL_CONTENT = sobreMi.contenidoAlRevelar;
const ROLES = sobreMi.rolesBarra;
